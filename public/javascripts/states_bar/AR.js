...
(function(){
        ...
        var dataCSV = "../data/bars/data"+config.state+"Turnout.csv";
...
(function(){
        ...
        //start CSV for bar charts
        var dataCSV = "../data/bars/dataARRegistration.csv";
...
(function(){
        ...
        //start CSV for bar charts
        var dataCSV = "../data/bars/dataARContact.csv";
...
(function(){
        ...
        //start CSV for bar charts
        var dataCSV = "../data/bars/dataARBoycot.csv";
...
(function(){
        ...
        //start CSV for bar charts
        var dataCSV = "../data/bars/dataARGroup.csv";
...
(function(){
        ...
        //start CSV for bar charts
        var dataCSV = "../data/bars/dataARVolunteer.csv";
...
(function(){
        ...
        //start CSV for bar charts
        var dataCSV = "../data/bars/dataARMeeting.csv";
...
(function(){
        ...
        //start CSV for bar charts
        var dataCSV = "../data/bars/dataARNeighbor.csv";
...
(function(){
        ...
        //start CSV for bar charts
        var dataCSV = "../data/bars/dataARDonate.csv";
